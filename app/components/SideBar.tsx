...
const SideBar = ({ setOnClick }: any) => {
    return (
        <div className="bg-gradient-to-b from-yellow-500 to-green-500 h-full flex flex-col justify-between w-full lg:w-64">
            ...
            <div className="flex flex-wrap lg:flex-col items-center lg:space-y-2 pb-8">
            ...
            <div onClick={() => setOnClick('History')} className="lg:w-40 py-2 px-4 rounded-md cursor-pointer font-bold text-center text-white transition duration-100 transform hover:scale-105 hover:shadow-lg border mx-auto my-3">
                Order History
            </div>
        </div>
    );
